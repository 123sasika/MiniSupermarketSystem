        ...
        <table class="table" id="table">
                ...
                <tbody>
                    <tr>
                        ...
                        <!-- create button -->
                        <td>
                            <button class="btn btn-warning px-3" id="submit1"><a href="UpdateDiscountsOffers.php?id=<?php echo $Discount_ID;?>" style="text-decoration:none; color:white;">Update</a></button>
                        </td>
                        <td>
                            <button class="btn btn-success px-3" id="submit3"><a href="DeleteDiscountsOffers1.php?ID=<?php echo $Discount_ID;?>" style="text-decoration:none; color:white;">Delete</a></button>
                        </td>
                    </tr>
                    <?php }}?>
                </tbody>
